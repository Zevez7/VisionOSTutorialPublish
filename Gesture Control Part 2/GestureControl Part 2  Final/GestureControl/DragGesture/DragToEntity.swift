...
struct DragToEntity: View {
    ...
    init(){
        ...
        self.sphereEntity1 = gestureClass.createSphereEntity(color:.white, x:0.0)
        
        self.sphereEntity2 = gestureClass.createSphereEntity(color:.purple, x:0.3)
        self.sphereEntity3 = gestureClass.createSphereEntity(color:.green, x:0.6)
    }
    ...
    var body: some View {
        RealityView { content in
            ...
            DragGesture().targetedToEntity(sphereEntity1).onChanged { value in
